(defproject dashboard "0.1.0-SNAPSHOT"
  ...
  :dependencies [[org.clojure/clojure "1.7.0"]
                 ...
                 [yesql "0.4.2"]                            ; db access
                 [com.taoensso/sente "1.5.0"]               ; web-sockets/ajax comms
                 ...
                 [clj-dbcp      "0.8.1"]
                 [clj-liquibase "0.5.2"]
                 [figwheel "0.3.7" :exclusions [junit org.clojure/clojurescript]]
                 [org.clojure/data.xml "0.0.8"]]

  :plugins [[lein-ancient "0.5.5"]                          ; check for outdated dependencies
            [lein-cljsbuild "1.0.5"]                        ; compile clojure scirpt
            [lein-environ "1.0.0"]
            [lein-figwheel "0.3.3" :exclusions [org.clojure/clojure org.clojure/tools.reader org.codehaus.plexus/plexus-utils]]]
